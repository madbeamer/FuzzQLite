...
class MutationCoverageFuzzer:
    ...
    def update_population(self, run_results: Dict[str, RunResult], new_coverage: Set[Tuple[str, int]]) -> None:
        """
    ...
    def run(self, runner: SQLiteStmtCoverageRunner) -> Tuple[Dict[str, RunResult], Set[Tuple[str, int]]]:
